...
urlpatterns = [
    ...
    url(r'^buildings/(?P<building_id>[0-9]+)/$', views.make_building_page, name='building_page'),
    url(r'^buildings/(?P<building_id>[0-9]+)/edit/', views.BuildingUpdate, name='update_building'),
    url(r'^units/new/$', views.new_unit, name='new_unit'),
    url(r'^buildings/(?P<building_id>[0-9]+)/facilities/new', views.new_facility, name='new_facility'),
