...
urlpatterns = [
    ...
    url(r'^my_units/(?P<unit_id>[0-9]+)/bills/(?P<bill_id>[0-9]+)/payment_inital/$', views.payment_initial,
        name='payment_initial'),
    url(r'^my_units/(?P<unit_id>[0-9]+)/bills/(?P<bill_id>[0-9]+)/payment_final/$', views.payment_final,
        name='payment_final'),
